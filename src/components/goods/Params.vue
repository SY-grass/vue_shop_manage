  ...
  methods: {
    ...
    addParams () {
      this.$refs.addFormRef.validate(async valid => {
        ...
        if (res.meta.status !== 201) {
          return this.$message.error(`添加参数${this.titleText}'失败！`)
        }
        this.$message.success(`添加参数${this.titleText}成功!`)
        this.getParamsData()
    ...
    editParams () {
      this.$refs.editFormRef.validate(async valid => {
        ...
        if (res.meta.status !== 200) {
          return this.$message.error(`修改参数${this.titleText}失败！`)
        }
        this.$message.success(`修改参数${this.titleText}成功!`)
        this.getParamsData()
        this.editDialogVisible = false
      })
    },
